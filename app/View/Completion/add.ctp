    ...
    <?php echo $this->Form->create(); ?>
        <div>
            ...
            <div>
                <table>
                    ...
                    <tr <?php if (!empty($this->validationErrors['Completion']['GraduationCourse']['business_type'])) echo 'class="error"';?>>
                        <th><b>卒業後業種</b></th>
                        <td>
                            <?php echo $this->Form->input('Completion.GraduationCourse.business_type', array('label' => false, 'div' => false, 'id' => false, 'type' => 'select', 'class' => 'span6',  'options' => $BUSINESSTYPE, 'error'=>false, 'empty' => '----')); ?>
                    ...
                    <tr <?php if (!empty($this->validationErrors['Completion']['GraduationCourse']['remark'])) echo 'class="error"';?>>
                        <th><b>その他特記事項</b></th>
                        <td>
                            <?php echo $this->Form->input('Completion.GraduationCourse.remark', array('label' => false, 'div' => false, 'id' => false, 'type' => 'textarea', 'class' => 'span6', 'error'=>false)); ?>
            ...
            <div class="row" style="padding-top: 30px;">
                <p>
                    <?php echo $this->Form->submit('修了生にする', array('class' => 'btn btn-primary', 'name' => 'confirm', 'div' => false)); ?>
