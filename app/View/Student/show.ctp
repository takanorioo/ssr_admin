<div class='container'>
    ...
    <table class="table table-striped table-bordered table-smallheader">
        ...
        <tr>
            <th>入学日</th>
            <td colspan="3"><?php echo h($user['Student']['entrance_day']); ?></td>
        </tr>
        <tr>
            <th>住所</th>
    ...
    <div class="button_section">
        <div class="button_section2 span10"style="margin-bottom: 30px;margin-left: 270px;">
            <a href="/<?php echo $base_dir;?>/student/edit/<?php echo h($user['User']['id']); ?>" class="btn btn-primary span2">編集する</a>
            <a href="/<?php echo $base_dir;?>/student/delete/<?php echo h($user['User']['id']); ?>" class="btn btn-danger span2">削除する</a>
        </div>
    </div>
</div>
